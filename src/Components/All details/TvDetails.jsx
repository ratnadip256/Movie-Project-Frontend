...
import { asyncLoadtv, removetv } from "../../Redux/Store/actions/tvActions.jsx";
...
import TvSeasons from "./TvSeasons/TvSeasons.jsx";

const TvDetails = () => {
  document.title = "Scenix - TvDetails";
    ...
    >
      <div className="h-full w-full p-6 text-white">
        ...
        <div className="p-4 mt-5">
          <h1 className="font-semibold text-2xl">Seasons</h1>
          <TvSeasons data={info.detail.seasons} />
        </div>

        {/* //! Images screenshots */}
        {info?.images?.backdrops && (
          <div className="flex flex-col p-4 mt-4">
            <h1 className="font-semibold text-3xl">Screenshots</h1>
